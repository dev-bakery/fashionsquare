...
const Brand = () => {
  ...
  const handleChange = (checked, id) => {
    if (checked) {
      ...
      setIsFilteredItems([
        ...isFilteredItems,
        ...dummyBrandItemData.filter((item) => item.brandNo === id),
      ]);
  ...
  const handlePriceLow = (e, areacode) => {
    ...
    setIsFilteredItems(
      isFilteredItems.sort((a, b) => a.sellPrice - b.sellPrice)
    );
  };
  ...
  const handlePriceHigh = (e, areacode) => {
    ...
    setIsAreacode(areacode);
    setIsFilteredItems(
      isFilteredItems.sort((a, b) => b.sellPrice - a.sellPrice)
    );
  };
    ...
    <>
      <div
        className={classNames(
          "box__brand-index",
          brandSetting && "box__brand-index--result"
        )}
      >
        <div className='box__brand-index--inner'>
          ...
          {!brandSetting && (
            <div className='box__brand-section'>
              ...
              />
              <BrandTabPanel
                data={dummyData.brandData.tabs[isActive]}
                isKeywordActive={isKeywordActive}
                setIsKeyword={setIsKeyword}
                setIsKeywordActive={setIsKeywordActive}
              />
              <BrandInfo
                data={dummyData.brandData}
                isKeyword={isKeyword}
          ...
          {isFilteredItems.length !== 0 ? (
            ...
            <div className='box__error-search'>
              ...
              <span className='text__normal'>
                <em className='text__highlight'>선택한 필터</em>에 대한
                검색결과가 없습니다.
                <br />
              </span>
