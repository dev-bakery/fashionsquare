      ...
      <div className='box__option-content'>
        ...
        <ul className='list__sorting-option'>
          <li className='list-item list-item--active'>
            <a className='link' role='button' aria-label='판매 인기순으로 정렬하기' href='/n/fashionsquare/brand?f=b%3A36269&amp;s=8'>
          ...
          <li className='list-item'>
            <a className='link' role='button' aria-label='낮은 가격순으로 정렬하기' href='/n/fashionsquare/brand?f=b%3A36269&amp;s=1' data-montelena-acode='200005782' data-montelena-page_type='2'>
          ...
          <li className='list-item'>
            <a className='link' role='button' aria-label='높은 가격순으로 정렬하기' href='/n/fashionsquare/brand?f=b%3A36269&amp;s=2' data-montelena-acode='200005783' data-montelena-page_type='2'>
